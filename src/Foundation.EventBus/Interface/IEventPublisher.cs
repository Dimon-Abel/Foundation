...
namespace Foundation.EventBus.Interface
{
    ...
    public interface IEventPublisher
    {
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        void Publish<TEventData>(object eventSource, TEventData eventData, bool wait = true)
        ...
        /// <param name="eventData">事件数据</param>
        /// <param name="wait">是否等待结果返回</param>
        Task PublishAsync<TEventData>(object eventSource, TEventData eventData, bool wait = true)
            where TEventData : IEventData;
