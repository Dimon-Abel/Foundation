...
namespace Foundation.Core.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns></returns>
        public static string EncryptBase64(this string data)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string DecryptBase64(this string data)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        /// <returns>返回首字母为大写的完整字符串</returns>
        ...
        public static string GetConnectionStringSchemaName(this string connectionString, bool toUpper = true)
        {
            if (connectionString.IsNullOrWhiteSpace() || !connectionString.Contains(";"))
                return null;
            var items = connectionString.Split(';').ToList();
            foreach (var item in items)
            {
                if (!item.IsNullOrWhiteSpace() && item.Contains("="))
                {
                    var arr = item.Trim().Split('=');
                    var name = arr[0];
                    var value = arr[1];
                    if (name.EqualIgnoreCase("user id"))
        ...
        public static string GetChineseSpell(this string strText)
        {
            ...
            foreach (var vChar in strText)
                ...
                if (vChar >= 'a' && vChar <= 'z' || vChar >= 'A' && vChar <= 'Z')
                    ...
                    myStr.Append(PinYin.StrChineseFirstPy[vChar - 19968]);
        ...
        public static string GetFirstPinyin(this string strText)
        {
            ...
            if (vChar >= 'a' && vChar <= 'z' || vChar >= 'A' && vChar <= 'Z')
                ...
                myStr = PinYin.StrChineseFirstPy[vChar - 19968].ToString();
        ...
        public static string AddFirstPinyin(this string str)
        {
            ...
            if (vChar >= 19968 && vChar <= 40869)
            {
                ...
                var strNew = PinYin.StrChineseFirstPy[vChar - 19968].ToString();
                return strNew + str;
            }
    ...
    public static class PinYin
    {
        ...
        /// /summary>
        public const string StrChineseFirstPy =
