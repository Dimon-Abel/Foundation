...
namespace Foundation.Core.Extensions
{
    ...
    public static class DictionaryExtensions
    {
        ...
        /// <summary>
        /// 获取指定键的值，获取失败返回defaultValue
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="dic"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static TValue GetValue<TValue>(this IDictionary<string, object> dic, string key, TValue defaultValue)
        {
            if (dic == null || dic.Count == 0) return default;
            if (dic.TryGetValue(key, out object objValue))
                return objValue.CastTo(defaultValue);
            return default;
        }
    }
}